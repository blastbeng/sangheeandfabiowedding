...
const resources = {
  it: {
    translation: {
      ...
      "loading_more": "Caricamento altri ricordi...",
      ...
      "filter_by_person": "Filtra per persona",
      ...
      "upload_subtitle": "Carica le tue belle foto del nostro giorno speciale 🌹",
      "select_photos_videos": "Seleziona Foto e Video",
      "supported_formats": "Formati supportati: JPG, PNG, GIF, WEBP, MP4, MOV, WEBM",
      ...
      "max_files_notice": "Massimo {{max}} file per caricamento",
      "max_files_exceeded": "Numero massimo di file superato",
      ...
      "admin_bulk_approve_confirm": "Sei sicuro di voler approvare {{count}} media selezionati?",
      "admin_bulk_reject_confirm": "Sei sicuro di voler rifiutare {{count}} media selezionati?",
      "admin_bulk_delete_confirm": "Sei sicuro di voler eliminare {{count}} media selezionati?",
      ...
      "Cannot delete default admin account": "Impossibile eliminare l'account amministratore predefinito",
      "pending_approval_title": "Account in Attesa di Approvazione",
      "pending_approval_message": "💔 Il tuo account è in attesa di approvazione da parte dell'amministratore. Potrai accedere non appena un amministratore avrà attivato il tuo account.",
      ...
      "reject": "Rifiuta",
      "delete": "Elimina",
      "admin_detect_faces": "Rileva volti",
      "admin_detect_faces_no_approved": "Nessun media approvato selezionato per il rilevamento volti.",
      "admin_detect_faces_confirm_with_skipped": "Rileverò i volti su {{approved}} media approvati. {{skipped}} media non idonei verranno saltati. Continuare?",
      "admin_detect_faces_confirm": "Rileverò i volti su {{count}} media approvati. Continuare?",
      "admin_detect_faces_success": "Rilevamento volti completato con successo!",
      "admin_detect_faces_error": "Errore durante il rilevamento volti.",
      "admin_reject_confirm": "Sei sicuro di voler rifiutare questo media?",
      "admin_settings_frontend_url": "URL Frontend",
      "admin_settings_frontend_url_placeholder": "https://esempio.com",
      ...
      "Admin": "⭐ Admin",
      "Wedding Book": "📖 Libro di Nozze",
      "Select at least {min} images. If you select fewer, AI will automatically choose the best ones to reach {min}.": "Seleziona almeno {{min}} immagini. Se ne selezioni di meno, l'IA sceglierà automaticamente le migliori per raggiungere {{min}}.",
      "Filter by user": "Filtra per utente",
      "Generate Wedding Book": "Genera Libro di Nozze",
      ...
      "Failed to load media. Please try again.": "Caricamento media fallito. Riprova.",
      "No approved media found.": "Nessun media approvato trovato.",
      "Previously Generated Books": "Libri Generati in Precedenza",
      "No books generated yet.": "Nessun libro generato ancora.",
      "ID": "ID",
      "Status": "Stato",
      "Progress": "Progresso",
      "Media Count": "Numero Media",
      "Created": "Creato",
      "Actions": "Azioni",
      "Download": "Scarica",
      "Delete": "Elimina",
  ...
  ko: {
    translation: {
      ...
      "Clear all": "모두 지우기",
      "Clear filter": "필터 지우기",
      "upload_subtitle": "우리의 특별한 날의 아름다운 사진을 업로드하세요 🌹",
      "select_photos_videos": "사진 및 동영상 선택",
      "supported_formats": "지원 형식: JPG, PNG, GIF, WEBP, MP4, MOV, WEBM",
      ...
      "max_files_notice": "업로드당 최대 {{max}}개 파일",
      ...
      "admin_bulk_approve_confirm": "선택한 {{count}}개 미디어를 승인하시겠습니까?",
      "admin_bulk_reject_confirm": "선택한 {{count}}개 미디어를 거부하시겠습니까?",
      "admin_bulk_delete_confirm": "선택한 {{count}}개 미디어를 삭제하시겠습니까?",
      "admin_mod_col_preview": "🖼️",
      ...
      "Cannot delete default admin account": "기본 관리자 계정은 삭제할 수 없습니다",
      "pending_approval_title": "계정 승인 대기 중",
      "pending_approval_message": "💔 관리자 승인 대기 중입니다. 관리자가 계정을 활성화하면 로그인할 수 있습니다.",
      "go_to_home": "홈으로 이동",
      ...
      "reject": "거부",
      "delete": "삭제",
      "admin_detect_faces": "얼굴 인식",
      "admin_detect_faces_no_approved": "얼굴 인식할 승인된 미디어가 선택되지 않았습니다.",
      "admin_detect_faces_confirm_with_skipped": "승인된 {{approved}}개 미디어에서 얼굴을 인식합니다. {{skipped}}개 부적합 미디어는 건너뜁니다. 계속하시겠습니까?",
      "admin_detect_faces_confirm": "승인된 {{count}}개 미디어에서 얼굴을 인식합니다. 계속하시겠습니까?",
      "admin_detect_faces_success": "얼굴 인식이 성공적으로 완료되었습니다!",
      "admin_detect_faces_error": "얼굴 인식 중 오류가 발생했습니다.",
      "admin_reject_confirm": "이 미디어를 거부하시겠습니까?",
      "admin_settings_frontend_url": "프론트엔드 URL",
      "admin_settings_frontend_url_placeholder": "https://example.com",
      "Google OAuth": "Google OAuth",
      "Client ID": "클라이언트 ID",
      ...
      "Admin": "⭐ 관리자",
      "Wedding Book": "📖 웨딩북",
      "Select at least {min} images. If you select fewer, AI will automatically choose the best ones to reach {min}.": "최소 {{min}}장의 이미지를 선택하세요. 적게 선택하면 AI가 자동으로 최고의 이미지를 골라 {{min}}장을 채웁니다.",
      "Filter by user": "사용자별 필터",
      "Generate Wedding Book": "웨딩북 생성",
      "New Book": "새 책",
      "Select All": "전체 선택",
      "Deselect All": "전체 해제",
      "selected": "선택됨",
      ...
      "Regenerate": "재생성",
      "Retry": "다시 시도",
      "Loading media...": "미디어 로딩 중...",
      "Failed to load media. Please try again.": "미디어 로딩 실패. 다시 시도하세요.",
      "No approved media found.": "승인된 미디어가 없습니다.",
      "Previously Generated Books": "이전에 생성된 책",
      "No books generated yet.": "아직 생성된 책이 없습니다.",
      "ID": "ID",
      "Status": "상태",
      "Progress": "진행률",
      "Media Count": "미디어 수",
  ...
  en: {
    translation: {
      ...
      "loading_more": "Loading more memories...",
      ...
      "upload_subtitle": "Upload your beautiful photos of our special day 🌹",
      "select_photos_videos": "Select Photos & Videos",
      "supported_formats": "Supported formats: JPG, PNG, GIF, WEBP, MP4, MOV, WEBM",
      ...
      "max_files_notice": "Maximum {{max}} files per upload",
      ...
      "admin_bulk_approve_confirm": "Are you sure you want to approve {{count}} selected media?",
      "admin_bulk_reject_confirm": "Are you sure you want to reject {{count}} selected media?",
      "admin_bulk_delete_confirm": "Are you sure you want to delete {{count}} selected media?",
      "admin_mod_col_preview": "🖼️",
      ...
      "Cannot delete default admin account": "Cannot delete default admin account",
      "pending_approval_title": "Account Pending Approval",
      "pending_approval_message": "💔 Your account is pending admin approval. You will be able to log in once an administrator activates your account.",
      ...
      "reject": "Reject",
      "delete": "Delete",
      "admin_detect_faces": "Detect Faces",
      "admin_detect_faces_no_approved": "No approved media selected for face detection.",
      "admin_detect_faces_confirm_with_skipped": "Will detect faces on {{approved}} approved media. {{skipped}} ineligible media will be skipped. Continue?",
      "admin_detect_faces_confirm": "Will detect faces on {{count}} approved media. Continue?",
      "admin_detect_faces_success": "Face detection completed successfully!",
      "admin_detect_faces_error": "Error during face detection.",
      "admin_reject_confirm": "Are you sure you want to reject this media?",
      "admin_settings_frontend_url": "Frontend URL",
      "admin_settings_frontend_url_placeholder": "https://example.com",
      "Google OAuth": "Google OAuth",
      "Client ID": "Client ID",
      "Client Secret": "Client Secret",
      ...
      "Select at least {min} images. If you select fewer, AI will automatically choose the best ones to reach {min}.": "Select at least {{min}} images. If you select fewer, AI will automatically choose the best ones to reach {{min}}.",
      "Filter by user": "Filter by user",
      "Generate Wedding Book": "Generate Wedding Book",
      "New Book": "New Book",
      ...
      "Failed to load media. Please try again.": "Failed to load media. Please try again.",
      "No approved media found.": "No approved media found.",
      "Previously Generated Books": "Previously Generated Books",
      "No books generated yet.": "No books generated yet.",
      "ID": "ID",
      "Status": "Status",
      "Progress": "Progress",

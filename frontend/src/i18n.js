...
const resources = {
  it: {
    translation: {
      ...
      "select_photos_videos": "Seleziona Foto",
      "supported_formats": "Formati supportati: JPG, PNG, GIF, WEBP",
  ...
  ko: {
    translation: {
      ...
      "select_photos_videos": "사진 선택",
      "supported_formats": "지원 형식: JPG, PNG, GIF, WEBP",
  ...
  en: {
    translation: {
      ...
      "select_photos_videos": "Select Photos",

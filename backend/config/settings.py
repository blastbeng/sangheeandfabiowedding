...
MIDDLEWARE = [
    ...
    'users.middleware.ForceHttpsForProxyMiddleware',
...
# Social provider credentials (top-level so they are accessible as settings.GOOGLE_CLIENT_ID etc.)
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@sangheeandfabio.com')

...
from .views import (
    ...
    MediaThumbnailView,
    WeddingBookListView,
    WeddingBookDeleteView,
    WeddingBookLatestView,
...
urlpatterns = [
    ...
    path('users/<int:user_id>/profile-thumbnail/', UserProfileThumbnailView.as_view(), name='user-profile-thumbnail'),
    ...
    path('admin/wedding-book/', WeddingBookListView.as_view(), name='wedding-book-list'),
    path('admin/wedding-book/<int:book_id>/delete/', WeddingBookDeleteView.as_view(), name='wedding-book-delete'),
    path('admin/wedding-book/latest/', WeddingBookLatestView.as_view(), name='wedding-book-latest'),
